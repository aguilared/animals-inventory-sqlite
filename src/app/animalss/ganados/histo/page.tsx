...
import { useGanadosHisto } from "@/hooks/useGanadosHisto"; //select owners
...
const AnimalsCardQuery: NextPage = () => {
  ...
  const { status, data, error, isLoading, refetch } = useQuery({
    queryKey: ["Animalssaa"],
    queryFn: async () => {
      const data = await axios.get(`${DATABASEURL}animals/histo`);
      return data.data;
    },
  });
